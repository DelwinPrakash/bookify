...
export default function Nav() {
    ...
    return (
        <aside className="fixed bg-slate-900 h-16 sm:h-screen w-full sm:w-16 flex sm:flex-col items-center sm:justify-evenly text-slate-400 bottom-0 sm:top-0 z-10">
            <nav className="flex sm:flex-col w-full sm:h-full justify-around sm:items-center">
                {/* Home */}
                <Link to="/">
                    <svg
